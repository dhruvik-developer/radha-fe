    ...
    <div className="flex flex-col justify-center items-center min-h-screen p-4 font-sans text-gray-800 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      {loading ? (
        ...
        <>
          ...
          <div
            id="pdf-content"
            className={`relative bg-amber-50/30 backdrop-blur-sm shadow-[0_20px_50px_rgba(132,92,189,0.15)] overflow-hidden w-full max-w-4xl border border-white/50 ring-1 ring-purple-100/50 ${itemData?.rule === false ? "xl:w-[60%]" : ""}`}
          >
                      ...
                      >
                        ...
                        {session.waiter_service &&
                          ((session.waiter_service.entries &&
                            ...
                            <div className="px-5 py-4 bg-indigo-50/40 border-t border-indigo-100 page-break-inside-avoid">
